...
class pearsonAnalysis:
    ...
    def loadDataFromAPI(self, startTime, endTime, i):
        ...
        self.saveDataToJSON(self.df, 'pearsonCorrelationLARGE'+str(i)+'.json')
        return
...
startTime = [pd.to_datetime('2017-11-01 00:00'), pd.to_datetime('2017-11-10 00:00'),
             ...
             pd.to_datetime('2017-12-21 00:00'), pd.to_datetime('2017-12-31 00:00'),
             pd.to_datetime('2018-01-08 00:00'), pd.to_datetime('2018-01-18 00:00')]
endTime = [pd.to_datetime('2017-11-10 00:00'), pd.to_datetime('2017-11-19 00:00'),
           ...
           pd.to_datetime('2017-12-31 00:00'), pd.to_datetime('2018-01-08 00:00'),
           pd.to_datetime('2018-01-18 00:00'), pd.to_datetime('2018-01-28 00:00')]
lag = 30
for i in range(len(startTime)):
    PA.loadDataFromAPI(startTime[i], endTime[i], i)
result = PA.loadAndCreateNewJson(len(startTime))
MLobject = ML(result)
