...
function calculateNewGraph(i) {
  var historicalData = dataset[i].historical;
  var predictedData = dataset[i].predicted;
  var actualData = dataset[i].actual;
  ...
  for (var key in historicalData) {
    var time = historicalData[key].time;
    historicalTimeSeries.push(time);
    var rain = historicalData[key].rain;
  ...
  for (var _key in predictedData) {
    var _time = predictedData[_key].time;
    historicalTimeSeries.push(_time);
    var _rain = predictedData[_key].rain;
    predictedWeatherSeries.push(_rain);
  }

  console.log("after 2nd loop: " + historicalTimeSeries.length);

  for (var _key2 in actualData) {
    var _rain2 = actualData[_key2].rain;
    actualWeatherSeries.push(_rain2);
  }
...
},{"chart.js":"node_modules/chart.js/src/chart.js","./dataset":"dataset.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/charts.e31bb0bc.map